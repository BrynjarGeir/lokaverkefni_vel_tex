...
\def\thesiscredits{60 ECTS} 						% Credits awarded for the project
...
\def\thesissupervisors{Kristján Jónasson // Ólafur Pétur Pálsson}					% Names of supervisors (split by \\ if more than one).
\def\thesisnrofsupervisors{2}					% Number of supervisors (to use "Supervisor" vs. "Supervisors")
